    ...
    >
      <CardContent sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
          Obrigado pela sua confiança! Agora precisamos de algumas informações para iniciar sua mentoria personalizada.
        </Typography>
        ...
        >
          ...
          <Grid container spacing={2} sx={{ textAlign: 'left' }}>
            ...
            <Grid item xs={6}>
              <Typography variant="body2" sx={{ wordBreak: 'break-word', mr: 1.2 }}>
        ...
        <Button
          ...
          onClick={() => window.location.href = 'https://docs.google.com/forms/d/e/1FAIpQLScwl449XBx63BxdZT3-PKUt7kh_24mM7L5kv-ZLmDslkCjIyg/formResponse'}
          sx={{
            background: 'rgba(255, 255, 255, 0.2)',
            color: 'white',
            fontWeight: 'bold',
        ...
        >
          Preencher Formulário de Mentoria
        </Button>
      </CardContent>
    </Card>
  );
